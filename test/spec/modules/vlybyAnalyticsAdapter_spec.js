import vlybyAnalyticsAdapter from 'modules/vlybyAnalyticsAdapter.js';
...
describe('vlyby Analytics', function () {
  ...
  after(function () {
    vlybyAnalyticsAdapter.disableAnalytics();
  });
  ...
  describe('main test flow', function () {
    ...
    it('should catch all events', function () {
      sinon.spy(vlybyAnalyticsAdapter, 'track');
      ...
      sinon.assert.callCount(vlybyAnalyticsAdapter.track, 7);
    });
